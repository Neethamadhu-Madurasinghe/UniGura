...
class TutorChat extends Controller
{
    ...
    private ModelTutorNotification $notification;


    public function __construct()
    {
        $this->chat = $this->model('ModelTutorChat');
        $this->user = $this->model('ModelUser');
        $this->notification = $this->model('ModelTutorNotification');
...
//          Get the payload
            ...
            $body['tutor_id'] = $request->getUserId();
...
//            Determine the redirect link
            $redirectLink = "";
            if($request->isTutor()) {
                $redirectLink = "/UniGura/tutor/chat";
            } else {
